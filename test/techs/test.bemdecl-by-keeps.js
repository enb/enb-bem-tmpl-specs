...
var bemdeclByKeepsTech = require('../../lib/techs/bemdecl-by-keeps');

describe('techs', function () {
    describe('bemdecl-by-keeps', function () {
        var fileSystem;
        var bundles = {};
        var fsScheme = [
        ...
        it('must detect block', function (done) {
            bundles.block.runTechAndRequire(bemdeclByKeepsTech)
                .spread(function (res) {
        ...
        it('must detect mod of block', function (done) {
            bundles['block-mod'].runTechAndRequire(bemdeclByKeepsTech)
                .spread(function (res) {
                    res.deps.must.eql([
        ...
        it('must detect elem of block', function (done) {
            bundles.elem.runTechAndRequire(bemdeclByKeepsTech)
                .spread(function (res) {
                    res.deps.must.eql([
        ...
        it('must detect mod of elem', function (done) {
            bundles['elem-mod'].runTechAndRequire(bemdeclByKeepsTech)
                .spread(function (res) {
                    res.deps.must.eql([
        ...
        it('must be bem order', function (done) {
            bundles.fully.runTechAndRequire(bemdeclByKeepsTech)
                .spread(function (res) {
                    res.deps.must.eql([
                        { block: 'block' },
                        { block: 'block', mod: 'mod', val: true },
